...
if __name__ == '__main__':
    ...
    if points_to_add < 50:
        ...
        print("Net rating gain is between 50~74, pre tournament rating needs to be adjusted with PASS1 method! ")
    ...
    #     df_w_l_score = pd.read_csv('laopen_adj.csv')  ##after all the other players' rating being adjusted
        ...
        print("Net rating gain is greater than 75, pre tournament rating needs to be adjusted with PASS2 method! ")
        ...
        worst_loss_rating = df_w_l_score[df_w_l_score['winorlose']==' l']['rating'].min()
        print("Adjusted rating with tier pass2 method = ", int((A.rating + (best_win_rating + worst_loss_rating)/2)/2))
